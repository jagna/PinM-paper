...
Przed zdefiniowaniem zaangażowania w pracę z punktu widzenia psychologii, warto przytoczyć potoczną definicję tego słowa. Wg Słownika Języka Polskiego PWN \cite{web:pwn-eng}
\begin{quote}
...
Zaangażowanie w pracę nie jest ciągłym stanem podczas wykonywania pracy. Jego poziom może się zmieniać zależnie od tygodnia, czy dnia pracy \cite{bakker2010weekly}. Natomiast jest to powtarzający się stan, co jest wiązane z typem wykonywanej pracy i rodzajem organizacji, w której pracownik pracuje \cite{macey2008meaning}.
...
\section{Wpływ zaangażowania na pracowników}
